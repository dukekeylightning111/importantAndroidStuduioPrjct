...
public class NotificationBroadCast extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (sportingActivity == null) {
            createAndShowNotification(context, "Testing", "No sporting activity found.");
        } else {
            String title = sportingActivity.getTitle();
            String time = sportingActivity.getTime();
            createAndShowNotification(context, "title --- " + title + " בזמן " + time, "text----  " + "יש עוד X דקות עד פעולה זו.");
        }
    }
