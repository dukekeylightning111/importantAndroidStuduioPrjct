...
public class MapFragment extends Fragment implements OnMapReadyCallback {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        placeEditText = view.findViewById(R.id.place_edit_text);

        confirmButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (googleMap != null) {
                    if (placeEditText.getText().toString().isEmpty() != false) {
    ...
    public void onMapReady(GoogleMap map) {
        ...
        googleMap.moveCamera(CameraUpdateFactory.newLatLngZoom(israelLocation, 15));
    ...
    public String getAddressFromLocation(LatLng location) {
        ...
        try {
            List<Address> addresses = geocoder.getFromLocation(location.latitude, location.longitude, 5);
